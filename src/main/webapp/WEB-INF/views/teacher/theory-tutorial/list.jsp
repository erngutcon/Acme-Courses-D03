...
<acme:list>
	<acme:list-column code="teacher.theory-tutorial.list.label.title" path="title" width="20%"/>	
	<acme:list-column code="teacher.theory-tutorial.list.label.abstractText" path="abstractText" width="80%"/>
</acme:list>
