...
<acme:list>
	<acme:list-column code="teacher.lab-tutorial.list.label.title" path="title" width="20%"/>	
	<acme:list-column code="teacher.lab-tutorial.list.label.abstractText" path="abstractText" width="80%"/>
</acme:list>
